...
class TtlPolicyRunProcedure() extends BaseProcedure with ProcedureBuilder {
  ...
  override def build: Procedure = new TtlPolicyRunProcedure()

}

object TtlPolicyRunProcedure {
  val NAME = "ttl_policy_run"

  def builder: Supplier[ProcedureBuilder] = new Supplier[ProcedureBuilder] {
    override def get() = new TtlPolicyRunProcedure()
  }
}
