...
/**
 * Spark 4.x concrete implementation of {@link HoodieInternalRow}. Spark 4 added an abstract
 * {@code getVariant} to {@code SpecializedGetters} ({@link VariantVal} does not exist in Spark 3.5),
 * so it must be implemented in the Spark-4-specific subclass.
 */
